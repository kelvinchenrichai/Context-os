  ...
  return (
    <div id="share-receiver-page" className="flex-1 overflow-y-auto px-4 py-6 max-w-md mx-auto space-y-6 bg-white dark:bg-stone-950">
      ...
      <div className="flex items-center gap-3 border-b border-stone-100 dark:border-stone-900 pb-4">
        <div className="w-10 h-10 rounded-xl bg-keepo-600 dark:bg-keepo-400 text-white dark:text-keepo-950 flex items-center justify-center">
      ...
      {isSaved ? (
        <div id="share-success-box" className="bg-stone-50 dark:bg-stone-900/30 border border-stone-200 dark:border-stone-800 rounded-xl p-6 text-center space-y-4">
          ...
          <button
            ...
            className="w-full py-2 bg-keepo-600 hover:bg-keepo-700 dark:bg-keepo-400 dark:hover:bg-keepo-300 text-white dark:text-keepo-950 text-xs font-sans font-semibold rounded-lg"
          >
          ...
          <div className="space-y-4 pt-2">
            ...
            <div className="pt-4 border-t border-stone-100 dark:border-stone-900 flex flex-col gap-2">
              <button
                ...
                onClick={handleSave}
                className="w-full py-2.5 bg-keepo-600 hover:bg-keepo-700 dark:bg-keepo-400 dark:hover:bg-keepo-300 text-white dark:text-keepo-950 font-sans font-semibold rounded-lg text-xs"
              >
                Save & Analyze
              </button>
              <button
